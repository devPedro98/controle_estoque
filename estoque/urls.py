...
urlpatterns = [
    ...
    path('<int:pk>/', v.EstoqueEntradaDetail.as_view(), name='url_estoque_entrada_detail'), # noqa
    ...
    path('saida/<int:pk>/', v.EstoqueSaidaDetail.as_view(), name='url_estoque_saida_detail'), # noqa
