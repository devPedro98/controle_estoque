...
class EstoqueEntradaDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['url_list'] = 'estoque:url_estoque_entrada_list'
        return context
...
def estoque_entrada_add(request):
    ...
    movimento = 'e'
    url = 'estoque:url_estoque_entrada_detail'
...
class EstoqueSaidaDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['url_list'] = 'estoque:url_estoque_saida_list'
        return context
...
def estoque_saida_add(request):
    ...
    movimento = 's'
    url = 'estoque:url_estoque_saida_detail'
    context = estoque_add(request, template_name, movimento, url)
    if context.get('pk'):
        return HttpResponseRedirect(resolve_url(url, context.get('pk')))
    return render(request, template_name, context)
